...
CREATE TABLE ALIADO_COMERCIAL (
	...
	CONSTRAINT PK_CODIGO_ALIADO_COMERCIAL PRIMARY KEY(AC_CODIGO),
...
CREATE TABLE VENTA(
	...
	VEN_MONTOTOTAL NUMERIC(25,2) NOT NULL,
...
CREATE TABLE EXPLOTACION(
	...
	CONSTRAINT FK_YACIMIENTO_EXPLOTACION FOREIGN KEY (FK_EXP_YACIMIENTO) REFERENCES YACIMIENTO (YAC_CODIGO) ON DELETE CASCADE,
...
CREATE TABLE EMP_CF(
	...
	CONSTRAINT FK_EMPLEADO_ECF FOREIGN KEY (FK_ECF_EMPLEADO) REFERENCES EMPLEADO (EMP_CODIGO) ON DELETE CASCADE,
	CONSTRAINT FK_CARFAS_ECF FOREIGN KEY (FK_ECF_CARFAS) REFERENCES CAR_FAS (CF_CODIGO) ON DELETE CASCADE,
...
CREATE TABLE TM_FAS(
	...
	TMF_COSTO NUMERIC(15,2) NOT NULL DEFAULT 0,
...
CREATE TABLE HOR_ECF(
	...
	CONSTRAINT FK_ECF_HECF FOREIGN KEY (FK_HECF_ECF) REFERENCES EMP_CF (ECF_CODIGO) ON DELETE CASCADE,
	CONSTRAINT FK_HORARIO_HECF FOREIGN KEY (FK_HECF_HOR) REFERENCES HORARIO (HOR_CODIGO) ON DELETE CASCADE,
...
CREATE TABLE MAQ_FAS (
	...
	FK_MF_ESTATUS INTEGER ,
	CONSTRAINT PK_CODIGO_MF PRIMARY KEY (MF_CODIGO),
	CONSTRAINT FK_MAQUINARIA_MF FOREIGN KEY (FK_MF_MAQUINARIA) REFERENCES MAQUINARIA (MAQ_CODIGO) ON DELETE CASCADE,
	CONSTRAINT FK_FASE_MF FOREIGN KEY (FK_MF_TM_FASE) REFERENCES TM_FAS (TMF_CODIGO) ON DELETE CASCADE,
...
CREATE TABLE ALI_MM (
	AMM_CODIGO SERIAL,
	FK_AMM_ALIADO INTEGER NOT NULL,
	FK_AMM_MM INTEGER NOT NULL,
	CONSTRAINT PK_CODIGO_AMM PRIMARY KEY (AMM_CODIGO),
	CONSTRAINT FK_ALIADO_AMM FOREIGN KEY (FK_AMM_ALIADO) REFERENCES ALIADO_COMERCIAL (AC_CODIGO),
