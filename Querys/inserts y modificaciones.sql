/*
1) AGREGAR FK EN EXPLOTACION DE YACIMINETO Y ELIMINAR ESE DE FK
...
CREATE TABLE USUARIO(
	...
	FK_USU_EMPLEADO_CI INTEGER  NOT NULL,
...
DELETE FROM EMPLEADO WHERE emp_cedula = 27086052

SELECT * FROM USUARIO

SELECT * FROM CARGO

SELECT lug_codigo,lug_nombre,lug_tipo FROM LUGAR WHERE fk_lug_lugar = 359

SELECT * FROM LUGAR WHERE lug_nombre = 'Portuguesa'

SELECT lug_codigo,lug_nombre,lug_tipo FROM LUGAR WHERE lug_nombre = 'Agua Blanca'

SELECT emp_codigo FROM empleado WHERE emp_cedula = 27086052



SELECT E.emp_nombre,E.emp_apellido,Carg.car_nombre,U.usu_password FROM empleado AS E, usuario AS U , cargo AS Carg WHERE U.fk_usu_empleado_ci = E.emp_cedula AND E.fk_emp_cargo = Carg.car_codigo AND U.usu_usuario = $1;