...
--Se agrego modificaciones en explotacion
CREATE TABLE EXPLOTACION(
	EXP_CODIGO SERIAL,
	EXP_DURACION NUMERIC(25) NOT NULL DEFAULT 0,
...
--Se agrego modificaciones en car_fase
...
--Se agregp modificaciones en tm_fas
CREATE TABLE TM_FAS(
	TMF_CODIGO SERIAL,
...
--Modificaciones listas en la FK 
...
INSERT INTO yac_min(
	ym_codigo, fk_ym_yacimiento, fk_ym_minmetalico, fk_ym_minnometalico, ym_cantidad)
		...
		--Modificaciones En estos inserts
		INSERT INTO EXPLOTACION (FK_EXP_ESTATUS,FK_EXP_YACIMIENTO,EXP_DURACION) VALUES(3,30,100);
